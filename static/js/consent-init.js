  ...
  languages: {
    es: {
      consent_modal: {
        ...
        description:
          "Esta web no emite ni emitirá, transmite o transmitirá nunca ningún tipo de contenido desde sus servidores. Todos los contenidos aqui mostrados son de terceros.",
        primary_btn: {
          text: "Aceptar",
